...
impl Snake{
    // The new snake at the beginning will be 3 blocks long and moving to the right
    ...
    pub fn move_forward(&mut self, dir: Option<Direction>){
        ...
        // This may seem inverted, but since going from top left of the screen to bottom left that is positive. Not like a normal yaxis
